 ...
 * [cato.yml](cato.yml)
     * Determines how your purl.obolibrary.org/obo/cato/ redirects will be handled
     ...
     * Paste in the contents of [cato.yml](cato.yml)
 ...
 * [cato.md](cato.md)
     ...
     * Paste in the contents of [cato.md](cato.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
