These notes are for the EDITORS of cato
...
Make sure you have an ID range in the [idranges file](cato-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [cato-edit.owl](cato-edit.owl)

** DO NOT EDIT cato.obo OR cato.owl in the top level directory **

[../../cato.owl](../../cato.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/tsrsilva/caste-ontology) for details.
 ...
 * [cato-idranges.owl](cato-idranges.owl)
...
This generates derived files such as cato.owl and cato.obo and places
 ...
 * https://github.com/tsrsilva/caste-ontology/releases
 * https://github.com/tsrsilva/caste-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived cato.owl (`data-version` in
cato.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/cato.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/cato/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/tsrsilva/caste-ontology.svg?branch=master)](https://travis-ci.org/tsrsilva/caste-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/tsrsilva](https://travis-ci.org/profile/tsrsilva)
 2. click the "Sync account" button
 3. Click the tick symbol next to caste-ontology
